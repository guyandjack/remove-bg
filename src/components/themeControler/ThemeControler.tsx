...
const ThemeControler = () => {
  ...
  return (
    <label onClick={()=>handleTheme} className="swap swap-rotate  hover:text-primary">
      {/* this hidden checkbox controls the state */}
      <input type="checkbox" className="theme-controller" value="synthwave" />

      {/* sun icon */}
      <svg
        className="swap-off h-10 w-10 fill-current lg:w-[30px] lg:h-[30px] "
      ...
      {/* moon icon */}
      <svg
        className="swap-on h-10 w-10 fill-current lg:w-[30px] lg:h-[30px] "
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
      >
