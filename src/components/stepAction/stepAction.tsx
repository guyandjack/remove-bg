...
//import des images
import curvedDotedLine from "@/assets/images/curved-dotted-line.svg"
...
const StepAction = ( {content} : PropsType) => {
  return (
      ...
      <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="relative mt-12 lg:mt-20">
          <div class=" relative flex flex-col justify-start items-center text-center gap-y-12 lg:flex-row lg:justify-between">
            <div class="w-full hidden absolute inset-x-0  top-2 lg:block lg:px-[125px]">
              <img class="w-full" src={curvedDotedLine} alt="doted line" />
            </div>
            <div className={"relative z-10 w-[60%] lg:w-[250px]"}>
              ...
              <h3 
              dangerouslySetInnerHTML={{ __html: content.step_1.title }}
              class="mt-6 text-xl font-semibold leading-tight text-secondary md:mt-10">
            ...
            <div className={"relative z-10 w-[60%] lg:w-[250px]"}>
              ...
              <h3 
              dangerouslySetInnerHTML={{ __html: content.step_2.title }}
              class="mt-6 text-xl font-semibold leading-tight text-info md:mt-10">
            ...
            <div className={"relative z-10 w-[60%] lg:w-[250px]"}>
              ...
              <h3 
              dangerouslySetInnerHTML={{ __html: content.step_3.title }}
              class="mt-6 text-xl font-semibold leading-tight text-success md:mt-10">
