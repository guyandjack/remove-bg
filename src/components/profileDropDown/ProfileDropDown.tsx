...
const ProfileDropDown = ({ credit = 3, callback, textCredit = "Credits" }) => {
  return (
      ...
      >
        <li className="w-[130px]">
          <div className="flex flex-row justify-left items-center gap-4">
            ...
            <span className={credit < 2 ? "text-red-500" : "text-green-500"}>Guillaume</span>
          </div>
        </li>
        <li className="w-[130px]">
          <a
          ...
          >
            ...
            <span className={credit < 2 ? "text-red-500" : "text-green-500"}>{credit}</span>
          </a>
        </li>
        <li className="w-[130px]">
          <button
